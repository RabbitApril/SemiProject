		...
		<div class="login-inner">
			<div class="loginImg">
				<img
					...
					alt="클릭 시 메인화면으로" width="250px" height="250x"
			...
			<form id="frm-login">
				<div>
					<label>아이디</label> <input type="text" name="id" class="idwrite"
						autofocus>
				</div>
				<div>
					<label>비밀번호</label> <input type="password" name="pwd"
						class="pwdwrite" required>
				</div>
				<div>
					<label class="savepoint"> <input type="checkbox"
						name="saveId" class="chkbox"> 아이디 저장
					</label>
				</div>
				<div class="buttonlayout">
					<div class="loginFunction">
						<div style="cursor: pointer;" class="btn join">회원가입</div>
						<div style="cursor: pointer;" class="btn find info">아이디/비밀번호
							찾기</div>
					</div>
					<div class="btn login">
